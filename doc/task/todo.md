...
### [進行中] 心血管健康工具擴充與全站整合 (CARDIO-TOOLS-EXPANSION)
...
**詳細說明**: 
1. **工具開發**: **[已完成]** ASCVD、鈉鉀比、Zone 2 計算機開發皆已完成。
2. **全站整合 (進行中)**: 逐一檢查所有 `post/` 頁面，針對具有心血管相關聯性的營養素（如魚油、維生素 K2、鎂等）嵌入對應工具或「專業洞察卡」。
3. **內鏈結構優化**: 確保每個工具在相關文章中皆有正確的跳轉錨點與導流連結，強化內容深度。
